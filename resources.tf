...
resource "aws_nat_gateway" "nat" {
  ...
  subnet_id     = aws_subnet.public_1.id  # Attach to a public subnet
  tags = {
...
resource "aws_lb_listener" "front_end" {
  ...
  certificate_arn   = "arn:aws:iam::529088256671:server-certificate/my-self-signed-cert"  
...
resource "aws_security_group" "ec2_sg" {
  ...
  ingress {
    ...
    to_port     = 22
    protocol    = "tcp"
    cidr_blocks = ["10.0.0.0/16"]  # Allow traffic from ALB
  }
